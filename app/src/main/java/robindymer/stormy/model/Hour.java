...
public class Hour implements Parcelable {
    ...
    public Hour() { } // Constructor needed for parcelable
    ...
    public int getTemperature() {
        ...
        Double celsiusTemperature = mTemperature - 32;
    ...
    // Unwrap with private constructor
    ...
    public static final Creator<Hour> CREATOR = new Creator<Hour>() {
        ...
        public Hour createFromParcel(Parcel source) {
            return new Hour(source); // Call private constructor
        }
